...
public class FoxAndCrowOne extends Fragment {

    private Button play1,play2,play3;
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.fox_and_crow01,container,false);
        final MediaPlayer mediaPlayer001=MediaPlayer.create(getActivity(),R.raw.foxncrow_one);
       ...
       // final MediaPlayer mediaPlayer003=MediaPlayer.create(getActivity(),R.raw.lion_mouse_three);
        ...
        play1=(Button)view.findViewById(R.id.FoxAndCrowPlay01);
