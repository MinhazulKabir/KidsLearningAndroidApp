...
public class LionAndMouseTwo extends Fragment {

    private Button play1,play2,play3;
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.lion_and_mouse02,container,false);
        ...
        play1=(Button)view.findViewById(R.id.LionMousePlay02);
