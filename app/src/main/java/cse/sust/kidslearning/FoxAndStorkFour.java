...
public class FoxAndStorkFour extends Fragment {

    private Button play1,play2,play3;
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view =inflater.inflate(R.layout.fox_and_stork04,container,false);
        ...
        final MediaPlayer mediaPlayer003=MediaPlayer.create(getActivity(),R.raw.fox_stork_four);

        play1=(Button)view.findViewById(R.id.FoxAndStorkPlay04);
